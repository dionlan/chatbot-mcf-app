...
/*
    ...
    },
    {
      id:'r17',
      options: [
        { value: 1, label: 'Instagram', trigger: '18' },
        { value: 2, label: 'Site', trigger: '18' },
        { value: 3, label: 'Facebook', trigger: '18' },
        { value: 4, label: 'LinkedIn', trigger: '18' },
        { value: 5, label: 'Google', trigger: '18' },
        { value: 6, label: 'Conhecidos', trigger: '18' },
        { value: 7, label: 'Convênios com associações', trigger: '18' },
        { value: 8, label: 'Palestras e eventos', trigger: '18' },
        { value: 9, label: 'Outro', trigger: '18' },
      ],
    },
    {
      id: '18',
