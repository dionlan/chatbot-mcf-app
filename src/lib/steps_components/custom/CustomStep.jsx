...
class CustomStep extends Component {
  ...
  componentDidMount() {
    const { speak, step, previousValue, triggerNextStep, respostas } = this.props;
    ...
    setTimeout(() => {
      this.setState({ loading: false }, () => {
        ...
        speak(step, previousValue, respostas);
      });
    }, delay);
  }
...
CustomStep.propTypes = {
  ...
  respostas: PropTypes.objectOf(PropTypes.any).isRequired,
